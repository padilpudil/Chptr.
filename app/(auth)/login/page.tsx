...
import { BookOpen, Lock, Mail, AlertTriangle, ArrowRight, Sun, Moon } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-md bg-white dark:bg-slate-850 border border-indigo-500 p-8 sm:p-10 rounded-none shadow-xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="font-body-serif italic text-xs text-slate-500 dark:text-slate-400">
            Welcome back to Chptr - read, write, and connect.
          </p>
        </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <Link
                ...
                className="text-[10px] font-bold uppercase tracking-wider text-purple-655 dark:text-purple-400 hover:text-purple-550 hover:underline"
              >
                Forgot Password?
              </Link>
            </div>
